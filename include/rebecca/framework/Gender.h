#ifndef REBECCA_FRAMEWORK_GENDER_H
#define REBECCA_FRAMEWORK_GENDER_H
 ...
 */
class REBECCA_EXPORT Gender : public InnerTemplateListImpl
{
	public:
		 ...
		 *
		 * If any characaters inbetween the gender tag are 
		 ...
		 * returns a "Gender" transformation on the text.
		 *
		 * The gender transformation is achieved by calling
		 * GraphBuilderFramework::genderSubstitute() with 
		 * the text to transform.
		 * 
		 * @return A "Gender" transformation on the text
...
using rebecca::framework::impl::Gender;

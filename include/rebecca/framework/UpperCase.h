#ifndef REBECCA_FRAMEWORK_UPPERCASE_H
#define REBECCA_FRAMEWORK_UPPERCASE_H
 ...
 */
class REBECCA_EXPORT UpperCase : public InnerTemplateListImpl
{
	public:
		 ...
		 * returns a "UpperCase" transformation on the text.
		 *
		 * @return A "UpperCase" transformation on the text
...
using rebecca::framework::impl::UpperCase;

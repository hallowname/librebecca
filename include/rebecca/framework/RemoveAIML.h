#ifndef REBECCA_FRAMEWORK_REMOVEAIML_H
#define REBECCA_FRAMEWORK_REMOVEAIML_H
 ...
 * AIML XML tag "aiml" during AIML
 * file removal through 
 * GraphBuilder::removeGraph.  
 *
...
class REBECCA_EXPORT RemoveAIML : public AIML
{
	...
	public:
         ...
         *
		 * Also creates a default RemoveTopic object which 
		 * is important for 
		 * RemoveAIML::handleInnerTag()
		 *
		...
		/**
		 * Calls its internal default RemoveTopic Object's RemoveTopic::handleInnerTag() 
	...
	private:
		...
		* idiom on the internet for more information about this.
		*/
		RemoveAIMLImpl *m_pimpl;
};

} //end of namespace impl

//Expose just the class name to the framework namespace
using rebecca::framework::impl::RemoveAIML;

#ifndef REBECCA_FRAMEWORK_SRAI_H
#define REBECCA_FRAMEWORK_SRAI_H
 ...
 */
class REBECCA_EXPORT Srai : public InnerTemplateListImpl
{
	public:
		...
		/**
		 * Returns the string after calling InnerTemplateListImpl::getString()
		 * and then GraphBuilderFramework::checkedInfiniteLoopGetResponse()
		 * 
...
using rebecca::framework::impl::Srai;

#ifndef REBECCA_FRAMEWORK_SIZE_H
#define REBECCA_FRAMEWORK_SIZE_H
 ...
 */
class REBECCA_EXPORT Size : public InnerTemplate
{
	public:
		...
		/**
		 * Calls GraphBuilderFramework::getSize() and 
		 * returns this as a string.
		 *
		 * @return GraphBuilderFramework::getSize() as
		 * a string
		 *
		 * @exception InternalProgrammerErrorException is thrown 
		 * only if the error is so grave that the entire AIML 
...
using rebecca::framework::impl::Size;

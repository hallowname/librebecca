#ifndef REBECCA_FRAMEWORK_PERSON_H
#define REBECCA_FRAMEWORK_PERSON_H
 ...
 */
class REBECCA_EXPORT Person : public InnerTemplateListImpl
{
	public:
		 ...
		 *
		 * If any characaters inbetween the person tag are 
		 ...
		 * returns a "Person" transformation on the text.
		 *
		 * The person transformation is achieved by calling
		 * GraphBuilderFramework::personSubstitute() with 
		 * the text to transform.
		 * 
		 * @return A "Person" transformation on the text
...
using rebecca::framework::impl::Person;

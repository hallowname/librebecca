#ifndef REBECCA_FRAMEWORK_THATSTAR_H
#define REBECCA_FRAMEWORK_THATSTAR_H
 ...
 */
class REBECCA_EXPORT ThatStar : public InnerTemplate
{
	public:
		...
		/**
		 * Calls GraphBuilderFramework::getThatStar() 
		 * with the index attribute set through ThatStar::setAttribute() 
		 * and returns the result
		 * 
		 * @return the result of calling 
		 * GraphBuilderFramework::getThatStar()
	...
	private:
		...
		* idiom on the internet for more information about this.
		*/
		ThatStarImpl *m_pimpl;
};

} //end of namespace impl
//Expose just the class name to the framework namespace
using rebecca::framework::impl::ThatStar;

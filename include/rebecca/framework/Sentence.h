#ifndef REBECCA_FRAMEWORK_SENTENCE_H
#define REBECCA_FRAMEWORK_SENTENCE_H
 ...
 */
class REBECCA_EXPORT Sentence : public InnerTemplateListImpl
{
	public:
		 ...
		 * returns a "Sentence" transformation on the text.
		 *
		 * @return A "Sentence" transformation on the text
...
using rebecca::framework::impl::Sentence;

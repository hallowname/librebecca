#ifndef REBECCA_FRAMEWORK_LOWERCASE_H
#define REBECCA_FRAMEWORK_LOWERCASE_H
 ...
 */
class REBECCA_EXPORT LowerCase : public InnerTemplateListImpl
{
	public:		
		...
		/**
		 * Calls InnerTemplateListImpl::getString(), transforms
		 * it to lowercase and returns it.
		 *
		 * @return Returns the InnerTemplateListImpl::getString()
	...
	private:
		...
		* idiom on the internet for more information about this.
		*/
		LowerCaseImpl *m_pimpl;
};

} //end of namespace impl

//Expose just the class name to the framework namespace
using rebecca::framework::impl::LowerCase;

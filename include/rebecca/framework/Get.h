#ifndef REBECCA_FRAMEWORK_GET_H
#define REBECCA_FRAMEWORK_GET_H
 ...
 */
class REBECCA_EXPORT Get : public InnerTemplate
{
	...
	public:
		...
		/**
		 * Calls GraphBuilderFramework::getPredicate() with the
		 * name attribute set through Get::setAttribute() and returns
		 * the result
		 * 
...
using rebecca::framework::impl::Get;

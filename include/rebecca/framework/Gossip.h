#ifndef REBECCA_FRAMEWORK_GOSSIP_H
#define REBECCA_FRAMEWORK_GOSSIP_H
 ...
 */
class REBECCA_EXPORT Gossip : public InnerTemplateListImpl
{
	public:
		 ...
		 * then GraphBuilderFramework::storeGossip() with
		 * the result and returns an empty string.
		 *
...
using rebecca::framework::impl::Gossip;
